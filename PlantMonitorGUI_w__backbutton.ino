...
void absorbtionMenu(){
  ts.writeRegister8(STMPE_INT_STA, 0xFF);
    int myrand = 10;
     tft.fillRoundRect(250, 5, 50, 20, 1, tft.color565(254, 254, 254));
     tft.setCursor(250,10);
     tft.setTextSize(2);
     tft.setTextColor(BLACK);
     tft.println("Back");
  if(p.x > 245 && p.x < 300 && p.y > 35 && p.y < 85){
...
void moistureMenu(){
    ts.writeRegister8(STMPE_INT_STA, 0xFF);
    int myrand = 10;
     tft.fillRoundRect(250, 7, 50, 25, 1, tft.color565(254, 254, 254));
     tft.setCursor(250,10);
     tft.setTextSize(2);
     tft.setTextColor(BLACK);
     tft.println("Back");
...
void temperatureMenu(){
    ...
    digitalWrite(A5, HIGH);  
     ...
     tft.setTextColor(BLACK);
     tft.println("Back");
        if(p.x > 240 && p.x < 265 && p.y > 40 && p.y < 80){
    STATE = MAIN;
  }
